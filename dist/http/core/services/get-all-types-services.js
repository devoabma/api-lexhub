...
var get_all_types_services_exports = {};
__export(get_all_types_services_exports, {
  getAllTypesServices: () => getAllTypesServices
});
module.exports = __toCommonJS(get_all_types_services_exports);
    ...
    "/services/types/all",
    {
      schema: {
        ...
        querystring: import_zod2.default.object({
          ...
          id: import_zod2.default.string().cuid().optional(),
...
//# sourceMappingURL=get-all-types-services.js.map