...
var get_all_quantity_services_in_month_exports = {};
__export(get_all_quantity_services_in_month_exports, {
  getAllQuantityServicesInMonth: () => getAllQuantityServicesInMonth
});
module.exports = __toCommonJS(get_all_quantity_services_in_month_exports);
      ...
      schema: {
        ...
        response: {
          200: import_zod2.default.object({
            totalCurrentMonth: import_zod2.default.number(),
            totalPreviousMonth: import_zod2.default.number()
          })
        }
      }
    },
...
0 && (module.exports = {
  getAllQuantityServicesInMonth
});
//# sourceMappingURL=get-all-quantity-services-in-month.js.map