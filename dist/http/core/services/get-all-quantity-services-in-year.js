...
var get_all_quantity_services_in_year_exports = {};
__export(get_all_quantity_services_in_year_exports, {
  getAllQuantityServicesInYear: () => getAllQuantityServicesInYear
});
module.exports = __toCommonJS(get_all_quantity_services_in_year_exports);
      ...
      schema: {
        ...
        response: {
          200: import_zod2.default.object({
            totalCurrentYear: import_zod2.default.number(),
            totalPreviousYear: import_zod2.default.number()
          })
        }
      }
    },
...
0 && (module.exports = {
  getAllQuantityServicesInYear
});
//# sourceMappingURL=get-all-quantity-services-in-year.js.map