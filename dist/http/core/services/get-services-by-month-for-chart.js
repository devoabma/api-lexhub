...
var get_services_by_month_for_chart_exports = {};
__export(get_services_by_month_for_chart_exports, {
  getServicesByMonthForChart: () => getServicesByMonthForChart
});
module.exports = __toCommonJS(get_services_by_month_for_chart_exports);
        ...
        response: {
          200: import_zod2.default.array(
            import_zod2.default.object({
              data: import_zod2.default.string(),
              services: import_zod2.default.number()
            })
          )
        }
      }
...
0 && (module.exports = {
  getServicesByMonthForChart
});
//# sourceMappingURL=get-services-by-month-for-chart.js.map