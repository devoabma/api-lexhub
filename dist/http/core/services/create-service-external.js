...
var create_service_external_exports = {};
__export(create_service_external_exports, {
  createServiceExternal: () => createServiceExternal
});
module.exports = __toCommonJS(create_service_external_exports);
    ...
    "/services/external",
    {
      schema: {
        ...
        body: import_zod2.default.object({
          ...
          serviceTypeId: import_zod2.default.array(import_zod2.default.string().cuid()),
          observation: import_zod2.default.string().optional(),
          assistance: import_zod2.default.enum(["PERSONALLY", "REMOTE"]),
          status: import_zod2.default.enum(["OPEN", "COMPLETED"]).default("OPEN")
        }),
        response: {
...
0 && (module.exports = {
  createServiceExternal
});
//# sourceMappingURL=create-service-external.js.map