...
// src/http/middlewares/auth.ts
var auth = (0, import_fastify_plugin.fastifyPlugin)(async (app2) => {
...
async function activeAgent(app2) {
...
async function authenticate(app2) {
    ...
    "/agents/all",
    {
      schema: {
        ...
        querystring: import_zod5.default.object({
          pageIndex: import_zod5.default.coerce.number().default(1),
          name: import_zod5.default.string().optional(),
          role: import_zod5.default.enum(["ADMIN", "MEMBER"]).optional()
        }),
        response: {
          200: import_zod5.default.object({
            agents: import_zod5.default.array(
              import_zod5.default.object({
                ...
                inactive: import_zod5.default.date().nullable()
              })
            ),
...
async function inactiveAgent(app2) {
  app2.withTypeProvider().register(auth).patch(
    "/agents/inactive/:id",
    {
      schema: {
...
async function logoutAgent(app2) {
...
async function updateAgent(app2) {
    ...
    "/agents/update/:id",
    {
      schema: {
        ...
        body: import_zod11.default.object({
          ...
          email: import_zod11.default.string().email().optional(),
          role: import_zod11.default.enum(["ADMIN", "MEMBER"]).optional()
        }),
        response: {
...
async function cancelService(app2) {
...
var API_PROTHEUS_FIN_URL = import_axios2.default.create({
  baseURL: env.API_PROTHEUS_FIN_URL
});
var API_PROTHEUS_DATA_URL = import_axios2.default.create({
  baseURL: env.API_PROTHEUS_DATA_URL
});

// src/http/core/services/consult-lawyer.ts
var import_zod13 = require("zod");
async function consultLawyer(app2) {
  app2.withTypeProvider().register(auth).post(
    ...
    "/services",
    {
      schema: {
        ...
        body: import_zod14.z.object({
          oab: import_zod14.z.string(),
          serviceTypeId: import_zod14.z.array(import_zod14.z.string().cuid()),
          observation: import_zod14.z.string().optional(),
          assistance: import_zod14.z.enum(["PERSONALLY", "REMOTE"]),
          status: import_zod14.z.enum(["OPEN", "COMPLETED"]).default("OPEN")
        }),
        response: {
          201: import_zod14.z.null()
        }
      }
    },
    async (request, reply) => {
...
async function createServiceExternal(app2) {
  app2.withTypeProvider().register(auth).post(
    "/services/external",
    {
      schema: {
        ...
        body: import_zod15.default.object({
          oab: import_zod15.default.string(),
          name: import_zod15.default.string(),
          email: import_zod15.default.string().email(),
          serviceTypeId: import_zod15.default.array(import_zod15.default.string().cuid()),
          observation: import_zod15.default.string().optional(),
          assistance: import_zod15.default.enum(["PERSONALLY", "REMOTE"]),
          status: import_zod15.default.enum(["OPEN", "COMPLETED"]).default("OPEN")
        }),
        response: {
          201: import_zod15.default.null()
        }
      }
    },
    async (request, reply) => {
...
async function createTypeService(app2) {
  app2.withTypeProvider().register(auth).post(
    "/services/types",
    {
      schema: {
...
async function finishedService(app2) {
  app2.withTypeProvider().register(auth).patch(
...
async function getAllQuantityServices(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/general",
    {
      schema: {
        ...
        response: {
          200: import_zod18.default.object({
            total: import_zod18.default.number()
          })
        }
      }
    },
...
async function getAllQuantityServicesByAgent(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/general/agent/:id",
    {
      schema: {
        ...
        params: import_zod19.z.object({
          id: import_zod19.z.string().uuid()
        }),
        response: {
          200: import_zod19.z.object({
            totalGeneral: import_zod19.z.number(),
            totalOnMonth: import_zod19.z.number(),
            totalOnPreviousMonth: import_zod19.z.number()
          })
        }
      }
    },
...
async function getAllQuantityServicesInMonth(app2) {
  app2.withTypeProvider().register(auth).get(
      ...
      schema: {
        ...
        response: {
          200: import_zod20.default.object({
            totalCurrentMonth: import_zod20.default.number(),
            totalPreviousMonth: import_zod20.default.number()
          })
        }
      }
    },
...
async function getAllQuantityServicesInYear(app2) {
  app2.withTypeProvider().register(auth).get(
      ...
      schema: {
        ...
        response: {
          200: import_zod21.default.object({
            totalCurrentYear: import_zod21.default.number(),
            totalPreviousYear: import_zod21.default.number()
          })
        }
      }
    },
...
async function getAllServices(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/all",
    {
      schema: {
        ...
        querystring: import_zod22.default.object({
          ...
          oab: import_zod22.default.string().optional(),
          lawyerName: import_zod22.default.string().optional(),
          agentName: import_zod22.default.string().optional(),
          assistance: import_zod22.default.enum(["PERSONALLY", "REMOTE"]).optional(),
          // Filtro por tipo de assistance
          status: import_zod22.default.enum(["OPEN", "COMPLETED"]).optional()
          // Filtro por status
        }),
        response: {
          200: import_zod22.default.object({
            services: import_zod22.default.array(
              import_zod22.default.object({
                id: import_zod22.default.string().uuid(),
                assistance: import_zod22.default.enum(["PERSONALLY", "REMOTE"]),
                observation: import_zod22.default.string().nullable(),
                status: import_zod22.default.enum(["OPEN", "COMPLETED"]),
                createdAt: import_zod22.default.date(),
                finishedAt: import_zod22.default.date().nullable(),
                lawyer: import_zod22.default.object({
                  id: import_zod22.default.string().uuid(),
                  name: import_zod22.default.string(),
                  oab: import_zod22.default.string(),
                  email: import_zod22.default.string()
                }),
                agent: import_zod22.default.object({
                  id: import_zod22.default.string().uuid(),
                  name: import_zod22.default.string(),
                  email: import_zod22.default.string(),
                  role: import_zod22.default.enum(["ADMIN", "MEMBER"])
                }),
                serviceTypes: import_zod22.default.array(
                  import_zod22.default.object({
                    serviceType: import_zod22.default.object({
...
async function getAllTypesServices(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/types/all",
    {
      schema: {
        ...
        security: [{ bearerAuth: [] }],
        querystring: import_zod23.default.object({
          pageIndex: import_zod23.default.coerce.number().default(1),
          id: import_zod23.default.string().cuid().optional(),
...
async function getAllTypesServicesWithoutPagination(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/types/all-wp",
    {
      schema: {
        ...
        security: [{ bearerAuth: [] }],
        response: {
          200: import_zod24.default.object({
            servicesTypes: import_zod24.default.array(
...
async function updateTypeService(app2) {
  app2.withTypeProvider().register(auth).put(
    "/services/types/update/:id",
    {
      schema: {
        ...
        security: [{ bearerAuth: [] }],
        params: import_zod25.default.object({
          id: import_zod25.default.string().cuid()
        }),
        body: import_zod25.default.object({
          name: import_zod25.default.string().min(6)
        }),
        response: {
          204: import_zod25.default.null()
        }
      }
    },
    async (request, reply) => {
...
async function createAccountService(app2) {
  app2.withTypeProvider().register(auth).post(
    "/agents",
    {
      schema: {
        ...
        body: import_zod26.z.object({
          ...
          password: import_zod26.z.string().min(8)
        }),
        response: {
          201: import_zod26.z.null()
        }
      }
    },
    async (request, reply) => {
...
async function getServicesByMonthForChart(app2) {
  app2.withTypeProvider().register(auth).get(
    "/services/monthly",
    {
      schema: {
        ...
        security: [{ bearerAuth: [] }],
        response: {
          200: import_zod27.default.array(
            import_zod27.default.object({
              data: import_zod27.default.string(),
              services: import_zod27.default.number()
            })
          )
        }
      }
...
async function routes(app2) {
  app2.register(createAccountService);
  app2.register(authenticate);
  app2.register(getProfile);
  app2.register(requestPasswordRecover);
  app2.register(resetPassword);
  app2.register(getAll);
  app2.register(updateAgent);
  app2.register(inactiveAgent);
  app2.register(activeAgent);
  app2.register(logoutAgent);
  app2.register(createTypeService);
  app2.register(getAllTypesServices);
  app2.register(updateTypeService);
  app2.register(createService);
  app2.register(createServiceExternal);
  app2.register(consultLawyer);
  app2.register(getAllServices);
  app2.register(finishedService);
  app2.register(cancelService);
  app2.register(getAllQuantityServices);
  app2.register(getAllTypesServicesWithoutPagination);
  app2.register(getAllQuantityServicesInMonth);
  app2.register(getAllQuantityServicesInYear);
  app2.register(getAllQuantityServicesByAgent);
  app2.register(getServicesByMonthForChart);
}
...
app.register(import_swagger.fastifySwagger, {
  openapi: {
    info: {
      title: "API LexHub",
      description: "\u{1F4DA} API LexHub (OAB Atende) | Sistema de Gest\xE3o de Atendimentos da OAB Maranh\xE3o",
      version: "1.0.0"
    },
    components: {
      securitySchemes: {
...
app.register(import_rate_limit.fastifyRateLimit, {
  max: 100,
...
app.listen({
  ...
  console.log(`
    \u{1F680} \x1B[32m> Servidor iniciado com sucesso!\x1B[0m \u2728
    \u{1F4E1} \x1B[33m> Aguardando conex\xF5es na porta ${env.PORT}...\x1B[0m
    `);
});
