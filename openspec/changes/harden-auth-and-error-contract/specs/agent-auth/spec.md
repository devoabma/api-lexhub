...
**Reason**: Funcionário inativado continuava usando a API por até 1 dia (DT-03). Substituído por "Revogação do acesso de funcionário inativo".
**Migration**: Nenhuma ação dos clientes. O frontend passa a receber `401` na primeira requisição após a inativação e deve tratá-lo como sessão encerrada.
